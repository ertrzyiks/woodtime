...
const AddVirtualChallenge = () => {
  ...
  const [getPoints, { loading, data }] = useLazyQuery(
    GetVirtualPointsDocument,
    {
  ...
  const initialPoint: [number, number] = useMemo(
    () => [54.372158, 18.638306],
    [],
  );
  ...
  return (
    <div>
      ...
      <div
        style={{ position: 'fixed', bottom: 12, left: 12, right: 12, top: 300 }}
      >
        <Map
