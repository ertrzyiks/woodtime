...
export type InviteToEventMutation = { __typename?: 'Mutation', inviteToEvent: { __typename?: 'InviteToEventPayload', success: boolean, event: { __typename?: 'EventDocument', id: string } | null } | null };
