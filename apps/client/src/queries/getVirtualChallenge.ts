...
export type GetVirtualChallengeQuery = { __typename?: 'Query', virtualChallenge?: { __typename?: 'VirtualChallenge', id: number, name: string, createdAt: string, checkpoints: { __typename?: 'CoordinatesConnection', totalCount: number, points: Array<{ __typename?: 'Coordinates', lat: string, lng: string }> } } | null | undefined };
