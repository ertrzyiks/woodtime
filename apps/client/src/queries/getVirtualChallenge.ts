...
export type GetVirtualChallengeQuery = {
  __typename?: 'Query';
  virtualChallenge: {
...
export const GetVirtualChallengeDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getVirtualChallenge' },
      variableDefinitions: [
        {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'virtualChallenge' },
            arguments: [
              {
                kind: 'Argument',
  ...
  GetVirtualChallengeQuery,
  GetVirtualChallengeQueryVariables
>;
