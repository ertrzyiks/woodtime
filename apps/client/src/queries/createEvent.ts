...
export type CreateEventMutation = { __typename?: 'Mutation', createEvent?: { __typename?: 'CreateEventResult', event: { __typename?: 'Event', id: number, name: string, type: number, checkpoint_count: number, created_at: string, updated_at: string } } | null | undefined };
