...
export type GetVirtualChallengesQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type GetVirtualChallengesQuery = {
  __typename?: 'Query';
  virtualChallenges: {
...
export const GetVirtualChallengesDocument = {
  ...
  definitions: [
    {
      ...
      operation: 'query',
      name: { kind: 'Name', value: 'getVirtualChallenges' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'virtualChallenges' },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                {
  ...
  GetVirtualChallengesQuery,
  GetVirtualChallengesQueryVariables
>;
