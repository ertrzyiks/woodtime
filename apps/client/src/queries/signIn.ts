...
export type SignInMutation = { __typename?: 'Mutation', signIn?: { __typename?: 'SignInPayload', success: boolean, user?: { __typename?: 'User', id: string, name: string } | null | undefined } | null | undefined };
