...
export type CreateVirtualChallengeMutation = {
  __typename?: 'Mutation';
...
export const CreateVirtualChallengeDocument = {
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'CreateVirtualChallengeInput' },
            },
          },
        },
      ],
  ...
  CreateVirtualChallengeMutation,
  CreateVirtualChallengeMutationVariables
>;
