...
export type EnrollVirtualChallengeMutation = { __typename?: 'Mutation', enrollVirtualChallenge: { __typename?: 'EnrollVirtualChallengeResult', success: boolean, event?: { __typename?: 'Event', id: number, name: string, type: number, checkpoint_count: number, created_at: string, updated_at: string } | null | undefined } };
